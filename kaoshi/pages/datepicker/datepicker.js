...
const conf = {
  ...
  onLoad(params) {
    ...
    userApi.xcx_login_new(function () {
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "LxzgzXcxApi/dk_classes", { }, function (res) {
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "LxzgzXcxApi/dk_my_dialys", {}, function (res) {
        that.setData({
